                ...
                <div class="space-y-5">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-y-8 md:gap-5">
                        <div class="relative w-48 h-48 mx-auto overflow-hidden border rounded-full md:w-56 md:h-56">
                            <img id="frame" src="<?= base_url('img/avatars/customer/' . $profile['avatar']); ?>" class="object-cover w-full h-full" alt="">
                        ...
                        <div class="col-span-2 space-y-6">
                            <div>
                                ...
                                <input type="text" name="fullname" id="fullname" value="<?= old('fullname', esc($profile['fullname'])); ?>" class="<?= (isset($validation['fullname'])) ? 'input-error' : 'input-customers' ?>" placeholder="John Doe" <?= (isset($validation['fullname'])) ? 'autofocus' : '' ?> />
                            ...
                            <div>
                                ...
                                <input type="text" name="username" id="username" value="<?= old('username', esc($profile['username'])); ?>" class="<?= (isset($validation['username'])) ? 'input-error' : 'input-customers' ?>" <?= (isset($validation['username'])) ? 'autofocus' : '' ?> placeholder="johndoe" />
                            ...
                            <div>
                                ...
                                <input type="email" name="email" id="email" value="<?= old('email', esc($profile['email'])); ?>" class="<?= (isset($validation['email'])) ? 'input-error' : 'input-customers' ?>" <?= (isset($validation['email'])) ? 'autofocus' : '' ?> placeholder="someone@example.com" />
                            ...
                            <div>
                                ...
                                <input type="text" name="phone_number" id="phone_number" value="<?= old('phone_number', esc($profile['phone_number'])); ?>" class="<?= (isset($validation['phone_number'])) ? 'input-error' : 'input-customers' ?>" <?= (isset($validation['phone_number'])) ? 'autofocus' : '' ?> placeholder="+62" />
                            ...
                            <div>
                                ...
                                <textarea name="address" id="adress" class="<?= (isset($validation['address'])) ? 'input-error' : 'input-customers h-20 md:h-30 resize-none' ?>" <?= (isset($validation['address'])) ? 'autofocus' : '' ?> placeholder="Jl. Teratai No. 123"><?= old('address', esc($profile['address'])); ?></textarea>
